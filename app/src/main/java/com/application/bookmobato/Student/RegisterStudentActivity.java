...
public class RegisterStudentActivity extends AppCompatActivity {
    ...
    FloatingActionButton addUseProfile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addUseProfile.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void findID() {
        ...
        addUseProfile = findViewById(R.id.addUserProf);
    ...
    public void connectionCheck() {
        ...
        if (!NetworkUtils.isInternetConnected(RegisterStudentActivity.this)) {
